...
| YAML Key       | CLI Flag | Type      | Default | Description                               |
| -------------- | -------- | --------- | ------- | ----------------------------------------- |
| `inspect_path` | ~        | `PathBuf` | `""`    | Path to directory containing audio files. |
...
| YAML Key        | CLI Flag | Type     | Default | Description    |
| --------------- | -------- | -------- | ------- | -------------- |
| `queue_rm_hash` | ~        | `String` | `""`    | A torrent hash |
...
| YAML Key | CLI Flag | Type     | Default | Description                                                                                                                                                                                                                                                           |
| -------- | -------- | -------- | ------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `source` | ~        | `String` | `""`    | Source as: torrent id, path to torrent file, or indexer url.<br>Examples:<br>`4871992`,<br>`path/to/something.torrent`,<br>`https://example.com/torrents.php?id=2259978&torrentid=4871992#torrent4871992`, or<br>`https://example.com/torrents.php?torrentid=4871992` |
