...
#[test]
fn indexer_deserialize_queue_item_with_legacy_string_indexer() {
    let yaml = "
...
#[test]
fn indexer_deserialize_queue_item_with_legacy_unknown_indexer() {
    let yaml = "
name: Test Album
...
#[test]
fn indexer_deserialize_queue_item_with_legacy_empty_indexer() {
    let yaml = "
name: Test Album
path: /downloads/test.torrent
hash: '0102030405060708090a0b0c0d0e0f1011121314'
...
/// without error.
#[test]
fn indexer_deserialize_queue_item_with_missing_indexer() {
    let yaml = "
name: Test Album
path: /downloads/test.torrent
hash: '0102030405060708090a0b0c0d0e0f1011121314'
