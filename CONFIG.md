...
| YAML Key    | CLI Flag      | Type   | Default | Description                                                                                                                                                  |
|-------------|---------------|--------|---------|--------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `no_sox_ng` | `--no-sox-ng` | `bool` | `false` | Use the original `SoX` binary instead of SoX-ng.<br>When set, the binary name changes from `sox_ng` to `sox` and the<br>`--single-threaded` flag is omitted. |
